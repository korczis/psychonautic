...
| Druh | Potence | Region |
|------|---------|--------|
| [P. azurescens](/shrooms/psilocybes/azurescens/) | **2,51%** | USA |
| [P. bohemica](/shrooms/psilocybes/bohemica/) | 1,34% | ČR |
| [P. semilanceata](/shrooms/psilocybes/semilanceata/) | 1,36% | Evropa |
| [P. cyanescens](/shrooms/psilocybes/cyanescens/) | 0,85% | Svět |
| [P. cubensis](/shrooms/psilocybes/cubensis/) | 0,63% | Tropy |
| [P. mexicana](/shrooms/psilocybes/mexicana/) | 0,35% | Mexiko |
...
| Látka | Ki (nM) | Aktivní dávka | Trvání |
|-------|---------|---------------|--------|
| [LSD](/alkaloids/lsd/) | **1-2** | 50-200 μg | 8-12 h |
...
| Princip | Popis |
|---------|-------|
| **Set** | Psychický stav uživatele |
| **Setting** | Bezpečné prostředí |
| **Substance** | Identifikace a správná dávka |
| **Sitter** | Střízlivý průvodce |
